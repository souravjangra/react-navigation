...
export default function MaterialTopTabView(_ref) {
  ...
  return /*#__PURE__*/React.createElement(View, {
    style: {
      flex: 1,
      backgroundColor: (_tabBarStyle$backgrou = tabBarStyle.backgroundColor) !== null && _tabBarStyle$backgrou !== void 0 ? _tabBarStyle$backgrou : colors.background
    }
